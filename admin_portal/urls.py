...
urlpatterns = [
    ...
    path('shops/<uuid:shop_id>/edit-location/', views.edit_shop_location, name='edit_shop_location'),
    ...
    path('payout-history/', views.payout_history, name='payout_history'),
    path('payout-history/<int:payout_id>/retry/', views.retry_payout, name='retry_payout'),
    path('shops/<uuid:shop_id>/verify-bank/', views.verify_bank_details, name='verify_bank_details'),
